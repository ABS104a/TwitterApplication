 ...
 * キャッシュを作って保存する
 */
public class MediaImageCache {

    private static final int MEDIASIZE = 20;
	private static ConcurrentLRUCache<String,ImageData> cache = new ConcurrentLRUCache<String,ImageData>(MEDIASIZE);
